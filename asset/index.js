...
//
const BotName = 'QwesHK BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/ridho_setiawan02'; // Nama Instagramlu cok
const whatsapplu = '0838-0744-9268'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = '1'; // OFFICIAL GRUP LU 1
const grupch2 = '2'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
